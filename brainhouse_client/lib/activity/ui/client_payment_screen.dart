...
import 'package:brainhouse_client/activity/client_invoice_details.dart';
import 'package:brainhouse_client/model/Invoices.dart';
  ...
  Widget _getItem(BuildContext context ,int index){
    return GestureDetector(
      onTap: ()=>Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ClientInvoiceDetails(
